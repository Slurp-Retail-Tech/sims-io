...
export const ENV_MANIFEST: readonly EnvSpec[] = [
  ...
  },
  {
    ...
    requirement: { kind: "optional" },
    why: "is optional and deprecated — a fallback for the letterhead on renewal documents, used only while Renewal Settings has no company details; set them in Settings instead",
    public: false,
    buildTime: false,
  },
  {
