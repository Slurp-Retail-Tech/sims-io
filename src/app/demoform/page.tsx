...
export default function DemoFormPage() {
  ...
  const submitLabel = submitting ? t.buttons.submitting : t.buttons.submit
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      window.setTimeout(() => {
        ...
        setAlert({ message: t.messages.missingWhatsapp, variant: "error" })
      }, 500)
    } catch (error) {
      ...
      <div className={styles.card}>
        ...
        <div className={styles.body}>
          ...
          <form id="demo-form" className={styles.form} onSubmit={onSubmit}>
            <input type="hidden" name="source" value="demo-form" />
            ...
            <div className={styles.fieldGroup}>
              <label htmlFor="business_name">
                {t.fields.businessName} <span className={styles.required}>*</span>
              </label>
              <input
                id="business_name"
                name="business_name"
