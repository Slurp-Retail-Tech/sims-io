...
function CommandDialog({
  title = "Command Menu",
  description = "Search for pages and merchants",
  children,
  className,
  shouldFilter,
  ...props
  ...
  return (
    <Dialog {...props}>
      ...
      >
        ...
        <Command shouldFilter={shouldFilter} className="[&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group]]:px-2 [&_[cmdk-input-wrapper]_svg]:size-4 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:size-4">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
